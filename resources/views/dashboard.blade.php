...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            <div>
                <h1 class="text-2xl font-black text-slate-800 dark:text-white uppercase tracking-tight">Tinjauan Lahan</h1>
            ...
            <button type="button" onclick="document.getElementById('lahanModal').classList.remove('hidden')"
                ...
                <div class="text-left">
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-wider leading-none">Lahan Terpilih</p>
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex items-baseline gap-3">
                        ...
                        <span class="bg-white/20 px-3 py-1 rounded-full text-[10px] font-bold backdrop-blur-md uppercase">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div
                ...
                <div>
                    <h3 class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Komoditas Utama</h3>
                    <p class="text-lg font-black text-slate-800 dark:text-white leading-none mb-2">
                        {{ $lahan->komoditas->nama_komoditas ?? 'N/A' }}
                    </p>
                    <span
                        class="text-[10px] bg-orange-100 text-orange-700 dark:bg-orange-500/30 dark:text-orange-300 px-2 py-1 rounded-lg font-black uppercase tracking-tighter">
                        Monitoring Aktif
                    </span>
                </div>
            </div>

            {{-- Rekomendasi Tindakan (Span 2) --}}
            <div
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-sm opacity-90 leading-relaxed font-medium">
                        ...
                        <b>{{ $lahan->komoditas->nama_komoditas ?? 'tanaman' }}</b> di wilayah <b>{{ $area }}</b>.
                    </p>
                </div>
            </div>
        </div>
