...
<head>
    ...
    <title>SmarTani - Daftar Akun Baru</title>
...
<body class="bg-white antialiased overflow-hidden h-screen flex flex-col md:flex-row">
    ...
    {{-- SISI KANAN: Register Form (Statis) --}}
    <div
        ...
        <div class="w-full max-w-sm mx-auto">
            <div class="mb-10">
                ...
                <p class="text-slate-500 mt-2 font-medium">Bergabung untuk mengelola ekosistem tani Anda</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-5">
                ...
                <div class="space-y-2">
                    <label
                        class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Nama Lengkap</label>
                ...
                <div class="space-y-2">
                    <label
                        class="block text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Konfirmasi Password</label>
